            ...
            <div className='container clearfix'>
              ...
              <div className='sidebar col_last nobottommargin'>
                ...
                <div className='widget noborder notoppadding'>
                  <a href='https://www.facebook.com/SoTecUK' target='_blank' className='social-icon si-small si-dark si-facebook'>
                    <i className='icon-facebook' />
                    <i className='icon-facebook' />
                  </a>
                  <a href='https://twitter.com/SoTec_UK' target='_blank' className='social-icon si-small si-dark si-twitter'>
