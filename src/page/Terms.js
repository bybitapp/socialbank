        ...
        <div className="mdl-layout mdl-js-layout mdl-layout--fixed-header">
          ...
          <main className="mdl-layout__content">
            <div className="page-content">
                ...
                <li>Make sure that any content (whether Pearls, Guides or otherwise) that you upload is your own. If you want to upload a photograph, it should be one that you have taken yourself.  If you are uploading comments or other text to Pearls or Guides, please use your own words and not someone else's.</li>
                ...
                <li>accessing your social media profiles, friends or connections, and email addresses if you choose to link your account to any social media networks made available through the Service;</li></ol>
                </li>
