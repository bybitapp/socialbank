          ...
          <div className='content-wrap'>
            <div className='container clearfix'>
              ...
              <ul style={{marginLeft: '22px'}}>
                ...
                <ul style={{marginLeft: '22px'}}>
                  <li style={{listStyleType: 'disc', fontSize: '10pt', backgroundColor: 'transparent', fontWeight: 400, fontVariant: 'normal', textDecoration: 'none', verticalAlign: 'baseline'}}><span style={styleText}>If you are unhappy with how we have handled your complaint and your card is issued by IDT Financial Services Limited, you can additionally contact them stating the nature of your complaint via </span><a style={{textDecoration: 'none'}} href='mailto:complaints@idtfinance.com'><span style={{color: '#000000', fontSize: '12pt', fontFamily: 'Arial', backgroundColor: 'transparent', fontWeight: 400, fontVariant: 'normal', textDecoration: 'underline', verticalAlign: 'baseline', whiteSpace: 'pre-wrap'}}>complaints@idtfinance.com</span></a> <span style={styleText}>&nbsp;or by post sent to the Address: IDT Financial Services Limited, Customer Services, PO Box 1374, Gibraltar. Once your complaint has been received by IDT Financial Services Limited, a complaints officer will investigate it and respond. </span></li>
                </ul>
              </ul>
