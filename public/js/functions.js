...
loadUI = function() {
  ...
  (function($) {
    ...
    window.$headerWrap = $('#header-wrap')
    window.$footer = $('#footer')
    window.oldHeaderClasses = $header.attr('class')
    window.oldHeaderWrapClasses = $headerWrap.attr('class')
    window.stickyMenuClasses = $header.attr('data-sticky-class')
    window.responsiveMenuClasses = $header.attr('data-responsive-class')
    window.defaultLogo = $('#logo').find('.standard-logo')
    window.defaultLogoWidth = defaultLogo.find('img').outerWidth()
    window.retinaLogo = $('#logo').find('.retina-logo')
    window.defaultLogoImg = defaultLogo.find('img').attr('src')
    window.retinaLogoImg = retinaLogo.find('img').attr('src')
    window.defaultDarkLogo = defaultLogo.attr('data-dark-logo')
    window.retinaDarkLogo = retinaLogo.attr('data-dark-logo')
    window.$pagemenu = $('#page-menu')
    window.$onePageMenuEl = $('.one-page-menu')
    window.onePageGlobalOffset = 0
    window.$portfolio = $('#portfolio')
    window.$slider = $('#slider')
    window.$sliderParallaxEl = $('.slider-parallax')
    window.$pageTitle = $('#page-title')
    window.$portfolioItems = $('.portfolio-ajax').find('.portfolio-item')
    window.$portfolioDetails = $('#portfolio-ajax-wrap')
    window.$portfolioDetailsContainer = $('#portfolio-ajax-container')
    window.$portfolioAjaxLoader = $('#portfolio-ajax-loader')
    window.prevPostPortId = ''
    window.$topSearch = $('#top-search')
    window.$topCart = $('#top-cart')
    window.$verticalMiddleEl = $('.vertical-middle')
    window.$topSocialEl = $('#top-social').find('li')
    window.$siStickyEl = $('.si-sticky')
    window.$dotsMenuEl = $('.dots-menu')
    window.$goToTopEl = $('#gotoTop')
    window.$fullScreenEl = $('.full-screen')
    window.$commonHeightEl = $('.common-height')
    window.$testimonialsGridEl = $('.testimonials-grid')
    window.$pageSectionEl = $('.page-section')
    window.$owlCarouselEl = $('.owl-carousel')
    window.$parallaxEl = $('.parallax')
    window.$parallaxPageTitleEl = $('.page-title-parallax')
    window.$youtubeBgPlayerEl = $('.yt-bg-player')
    window.$textRotaterEl = $('.text-rotater')
