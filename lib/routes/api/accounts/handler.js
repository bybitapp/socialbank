...
exports.demo = async function (req, res) {
  ...
  const {status, access, email, phone, profile} = user
  return res.send({email, phone, access, status, profile})
}
...
exports.login = async function (req, res) {
  ...
  if (user) {
    const {_id, access, email, phone, profile} = user
    return res.send({id: _id, access, email, phone, profile})
  } else {
