...
router.post('/login', async(req, res, next) => {
  ...
  passport.authenticate('local', async(err, user, info) => {
    ...
    req.logIn(user, async (err) => {
      ...
      // TODO get information about external account, filter does not work!!!
      ...
      const extAccount = extAccounts.externalAccounts.filter(item => { return item.friendlyName === externalAccountName})
