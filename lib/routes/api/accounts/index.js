...
router.post('/login', async (req, res, next) => {
  // TEMPORARY START
  // Intentionally throwing exception for testing
  console.log('Test request.')
  if (!req.params.noError) {
    // Couldn't handle this one :(... it's the same situation when OPC server fails to respond
    throw new Error('Test error.')

    // Below error works fine with the server.js defined formatter
