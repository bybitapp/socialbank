...
router.post('/send', async(req, res) => {
    try {
      ...
      let mailOptions = {
          ...
          text: `Name: ${value.name}; Email: ${value.email}; Message: ${value.message}`, // plain text body
          html: `<p>Name: ${value.name}</p><p>Email: ${value.email}</p><p>Message: ${value.message}</p>`  // html body
      };
