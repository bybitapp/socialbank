...
exports.create = async function create (req, res) {
  ...
  if (value.pid) {
    ...
    if (existingProject) {
      ...
      logger.log('success', { msg: `Project ${existingProject.id} updated` })
      return res.send({
  ...
  logger.log('success', { msg: `Project ${newProject.id} added to your account` })
  return res.send({
    id: newProject.id,
...
exports.delete = async (req, res) => {
  ...
  Project
    ...
    .then(project => {
      logger.log('success', { msg: `Project ${project.id} set to status inactive` })
      res.send({
        msg: 'success',
...
exports.deposit = async function deposit (req, res) {
  ...
  if (!bank) {
    return new errors.NotFoundError('Bank account not found')
  }
