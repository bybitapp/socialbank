...
exports.create = async function create (req, res) {
  ...
  const newProject = new Project({
    name: 'DEFAULT' || value.name, // TODO temporary solution for on default project
    default: true, // TODO temporary solution for on default project
...
exports.delete = async (req, res) => {
  ...
  // update project
  const existingProject = await Project.findOne({ _id: value.pid, default: false }).exec()
  if (!existingProject) {
    logger.error('client errors', error)
    throw new errors.ClientError('Invalid values. Default project cannot be deleted.')
  } else {
