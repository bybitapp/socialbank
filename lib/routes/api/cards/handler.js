...
exports.create = async function create (req, res) {
  ...
  if (!organization.isValid) {
    const errorMsg = 'We have to verify your organization. Please contact us to get information about progress.'
...
exports.delete = async function deleteCard (req, res) {
  ...
  if (existingCard) {
    ...
    logger.log('success', { msg: `Card ${existingCard.id} set to status deleted` })
    res.send({
      msg: 'success',
      id: existingCard.id
    })
...
exports.updateStatus = async function updateStatus (req, res) {
  ...
  if (existingCard) {
    ...
    logger.log('success', { msg: `Card ${existingCard.id} updated` })
