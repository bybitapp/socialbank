...
exports.createDeposit = async function createDeposit (value, extId, managedId) {
  ...
  const requestTest = new Opc.CreatePayinSimulationParams(amount, extId, 'SOTEC-TEST-PAYIN')
...
exports.getManagedCardCvv = async function getManagedCardCvv (cardId) {
  ...
  return api.managedCardsIdCvvGet(cardId, correlationId, programmeKey, token)
}
...
exports.unblockCard = async function unblockCard (id) {
  ...
  var request = new Opc.UnblockManagedCardParams(intentId, {blockType: 'OPERATOR'})
